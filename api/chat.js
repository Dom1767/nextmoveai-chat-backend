...
export default async function handler(req, res) {
  ...
  try {
    ...
    const siteMap =
      ...
      "connected 30/60/90-day roadmap (Financial Foundation, Smart " +
      "Priority, Budget Position, Emergency Protection, Money " +
      "Allocation).\n" +
    ...
    // own name (Dalo on the homepage, Petro on the free preview,
    // Veto on the unlimited page). Defaults to Dalo if not sent.
    const botName =
